...
"border-radius: 5px;")
        self.extruded_dist.setAlignment(QtCore.Qt.AlignCenter)
...
"color: rgb(255, 255, 255);\n"
"border-radius: 5px;")
        self.des_mult.setAlignment(QtCore.Qt.AlignCenter)
        self.des_mult.setObjectName("des_mult")
        self.calc_extrusion = QtWidgets.QLabel(self.centralwidget)
        self.calc_extrusion.setGeometry(QtCore.QRect(490, 350, 221, 31))
        self.calc_extrusion.setStyleSheet("background-color: rgb(165, 156, 156);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 5px;")
        self.calc_extrusion.setAlignment(QtCore.Qt.AlignCenter)
...
"color: rgb(255, 255, 255);\n"
"border-radius: 5px;")
        self.act_mult.setAlignment(QtCore.Qt.AlignCenter)
...
"border-radius: 5px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.extruded_dist.setStatusTip(_translate("MainWindow", "The amount in mm of measured filament after M83, G1 F50 E100"))
        self.extruded_dist.setText(_translate("MainWindow", "Measured Filament"))
        self.original_steps.setStatusTip(_translate("MainWindow", "Extruder steps in the M503 eeprom read-out"))
